...
#define led_amar  8           //pin12 conectado al led amarillo
...
String contrasenaCerradura = "50587447*";   //Variable donde almaceno la contraseña definida por el sistema
...
void loop()
{
  ...
  if(key)
  {
    ...
    if(key == '*')
    {
      ...
      {
        lcdCerradura.setCursor(0,1);
        lcdCerradura.print("Clave correcta");
        OFF(led_rojo);
        ON(led_verd);
      ...
      {
        lcdCerradura.setCursor(0,1);
        lcdCerradura.print("Clave incorrecta");
        delay(1000);
